<template>
  <div class="page-infinite">
    <h1 class="page-title">Infinite Scroll Two Ways</h1>
    ...
    <div class="page-infinite-wrapper" ref="wrapper" :style="{ height: wrapperHeight + 'px' }">
      ...
      <ul class="page-infinite-list" v-infinite-scroll-two-ways="{loadMore:loadMore,loadHistory:loadHistory}" infinite-scroll-two-ways-disabled="loading" infinite-scroll-two-ways-distance="50">
